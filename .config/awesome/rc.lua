...
-- Let's try Zenburn theme!
--beautiful.init(gears.filesystem.get_themes_dir() .. "zenburn/theme.lua")
-- Let's modify Zenburn!
beautiful.init(awful.util.getdir("config") .. "themes/my_zenburn/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Use fewer screens, I don't need that many and can only reach so far with one hand
	awful.tag({ "one", "two", "three", "four", "five", "six" }, s, awful.layout.layouts[1])
...
root.buttons(gears.table.join(
	...
	-- ncdulo, Oct 30 2019
	-- Disable mouse wheel scrolling through tags
